    ...
    SearchImage.prototype = {
        ...
        getImageData: function(){
            var _this = this,
                ...
                url = "https://image.baidu.com/search/acjson?tn=resultjson_com&ipn=rj&ct=201326592&is=&fp=result&queryWord=" + key + "&cl=2&lm=-1&ie=utf-8&oe=utf-8&adpicid=&st=-1&z=&ic=0&word=" + key + "&s=&se=&tab=&width=&height=&face=0&istype=2&qc=&nc=1&fr=&pn=120&rn=30&gsm=78&" + +new Date;
                    ...
                    if(json && json.data) {
                        for (var i = 0; i < json.data.length; i++) {
                            if (json.data[i].objURL) {
                                var fromurl = "###";
                                if (json.data[i].replaceUrl&&json.data[i].replaceUrl[0]&&json.data[i].replaceUrl[0].FromURL) {
                                    fromurl = json.data[i].replaceUrl[0].FromURL;
                                }
                                list.push({
